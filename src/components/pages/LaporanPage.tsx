    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white p-8 rounded-[30px] border-l-[6px] border-emerald-400 card-shadow">
          ...
          <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest mb-1">Total Pemasukan</p>
        ...
        <div className="bg-white p-8 rounded-[30px] border-l-[6px] border-rose-400 card-shadow">
          ...
          <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest mb-1">Total Pengeluaran</p>
        ...
        <div className="bg-white p-8 rounded-[30px] border-l-[6px] border-orange-400 card-shadow">
          ...
          <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest mb-1">Tagihan Pending</p>
